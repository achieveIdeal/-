...
$(function () {
  ...
  const CONFIG = {
    ...
    credentials: {
      ak: '412a628a1025456d83fdae14a459f076',	 // 填写你的百度云中ak和sk
      sk: 'd263dad9a5d740f097a6e20c456111ed'    // 在百度vod 安全认证里面
    }
  };
  ...
  $docsBtn.click(function (e) {
    ...
    .done(function (res) {
      if (res.code === 200) {
        ...
        fAlert.alertErrorToast(res.message);
      }
    })
    .fail(function () {
      popBox.showError('服务器超时，请重试！');
  ...
  $courseDel.click(function () {   // 2. 点击触发事件
    ...
    popBox.tooltip({
        ...
        function (value) {
          if (value) {
            $.ajax({
              url: "/cms/course/" + sCourseId + "/",  // url尾部需要添加/
              // 请求方式
              type: "DELETE",
              dataType: "json",
            })
